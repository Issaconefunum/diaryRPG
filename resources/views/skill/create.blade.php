            ...
            <div class="w-50">
                <form action="{{route("skill.store")}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="lastUsed" class="form-control" id="lastUsed" placeholder='Последнее использование'>
                    </div>
                    <br>
                    <div>
                        <select class="form-select" name="lvlSkill_id" aria-label="class">
                            <option selected>Выберите уровень навыка</option>
                    ...
                    <div class="layer5_margin-top">
                        <button type="submit" class="btn btn-primary btn-lg">Создать скилл</button>
                    </div>
                </form>
            </div>
        </div>
